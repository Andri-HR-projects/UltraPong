...
public class Background {
	...
	public static void drawDecoration() {
	...
	private static void drawMiddle(int x, int y) {
		clearModelMatrix();
	...
	private static void clearModelMatrix()
	{
	...
	private static void setModelMatrixTranslation(float xTranslate, float yTranslate)
	{
	...
	private static void setModelMatrixScale(float xScale, float yScale)
	{
